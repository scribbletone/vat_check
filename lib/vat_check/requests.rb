...
class VatCheck
  module Request
    def self.lookup(vat)
      client = Savon.client(wsdl: 'https://ec.europa.eu/taxation_customs/vies/checkVatService.wsdl', log: false, log_level: :debug, pretty_print_xml: false, follow_redirects: true)
